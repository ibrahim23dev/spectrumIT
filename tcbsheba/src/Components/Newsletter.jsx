...
const Newsletter = () => {
  return (
    <div className="container mx-auto p-6 bg-white border border-gray-400 rounded-lg shadow-md flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-6">
      <img src={NewsLetter} alt="Newsletter Illustration" className="h-64 w-full md:w-1/3 object-cover rounded-lg" />
